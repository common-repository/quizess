...
class ComposerStaticInit6976946bdcd0f4748451deb8ad722a9c
{
    ...
    public static $classMap = array (
        ...
        'Eightshift_Libs\\Assets\\Manifest' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/assets/class-manifest.php',
        'Eightshift_Libs\\Assets\\Manifest_Data' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/assets/interface-manifest-data.php',
        ...
        'Eightshift_Libs\\Exception\\Missing_Block' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/exception/class-missing-block.php',
        'Eightshift_Libs\\Exception\\Missing_Manifest' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/exception/class-missing-manifest.php',
        'Eightshift_Libs\\Routes\\Callable_Field' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/rest-routes/interface-callable-field.php',
        'Eightshift_Libs\\Routes\\Callable_Route' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/rest-routes/interface-callable-route.php',
        'Eightshift_Libs\\Routes\\Registrable_Field' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/rest-routes/interface-registrable-field.php',
        'Eightshift_Libs\\Routes\\Registrable_Route' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/rest-routes/interface-registrable-route.php',
        'Eightshift_Libs\\Routes\\Route' => __DIR__ . '/..' . '/infinum/eightshift-libs/src/rest-routes/interface-route.php',
        ...
        'Quizess\\Admin\\Admin' => __DIR__ . '/../..' . '/src/admin/class-admin.php',
        'Quizess\\Admin\\Media' => __DIR__ . '/../..' . '/src/admin/class-media.php',
        'Quizess\\Admin\\Menu' => __DIR__ . '/../..' . '/src/admin/class-menu.php',
        'Quizess\\Admin\\Menu_Page' => __DIR__ . '/../..' . '/src/admin/class-menu-page.php',
        'Quizess\\Admin\\Questions' => __DIR__ . '/../..' . '/src/admin/class-questions.php',
        'Quizess\\Admin\\Quiz' => __DIR__ . '/../..' . '/src/admin/class-quiz.php',
        'Quizess\\Admin\\Users' => __DIR__ . '/../..' . '/src/admin/class-users.php',
        'Quizess\\Assets\\Manifest' => __DIR__ . '/../..' . '/src/assets/class-manifest.php',
        'Quizess\\Assets\\Manifest_Helper' => __DIR__ . '/../..' . '/src/assets/class-manifest-helper.php',
        'Quizess\\Blocks\\Abstracts\\Base_Block' => __DIR__ . '/../..' . '/src/blocks/abstracts/class-base-block.php',
        'Quizess\\Blocks\\Blocks' => __DIR__ . '/../..' . '/src/blocks/class-blocks.php',
        'Quizess\\Blocks\\Blocks_Utils' => __DIR__ . '/../..' . '/src/blocks/class-blocks-utils.php',
        'Quizess\\Blocks\\Interfaces\\Block' => __DIR__ . '/../..' . '/src/blocks/interfaces/interface-block.php',
        'Quizess\\Blocks\\Section' => __DIR__ . '/../..' . '/src/blocks/class-section.php',
        'Quizess\\Core\\Config' => __DIR__ . '/../..' . '/src/class-config.php',
        'Quizess\\Core\\Main' => __DIR__ . '/../..' . '/src/class-main.php',
        'Quizess\\Front\\Front' => __DIR__ . '/../..' . '/src/front/class-front.php',
        'Quizess\\Languages\\Internationalization' => __DIR__ . '/../..' . '/src/languages/class-internationalization.php',
        'Quizess\\Routes\\Base_Route' => __DIR__ . '/../..' . '/src/rest/class-base-route.php',
        'Quizess\\Routes\\Field\\Post_Fields' => __DIR__ . '/../..' . '/src/rest/fields/class-post-fields.php',
        'Quizess\\Routes\\Route\\Get_Dashboard_Options' => __DIR__ . '/../..' . '/src/rest/routes/class-get-dashboard-options.php',
        'Quizess\\Routes\\Route\\Get_Menus' => __DIR__ . '/../..' . '/src/rest/routes/class-get-menus.php',
        'Quizess\\Routes\\Route\\Get_Quizess' => __DIR__ . '/../..' . '/src/rest/routes/class-get-quizess.php',
        'Quizess\\Routes\\Route\\Patch_General_Options' => __DIR__ . '/../..' . '/src/rest/routes/class-patch-general-options.php',
        'Quizess\\Routes\\Route\\Patch_Scores' => __DIR__ . '/../..' . '/src/rest/routes/class-patch-scores.php',
        'Quizess\\Routes\\Route\\Post_Scores' => __DIR__ . '/../..' . '/src/rest/routes/class-post-scores.php',
        'Quizess\\Routes\\Route_Security' => __DIR__ . '/../..' . '/src/rest/interface-route-security.php',
        'Quizess\\Routes\\Routes_Security' => __DIR__ . '/../..' . '/src/rest/class-routes-security.php',
        'Quizess\\Utils\\Compatibility' => __DIR__ . '/../..' . '/src/utils/class-compatibility.php',
        'Quizess\\Utils\\Error_Logger' => __DIR__ . '/../..' . '/src/utils/class-error-logger.php',
        'Quizess\\Utils\\Math_Utils' => __DIR__ . '/../..' . '/src/utils/class-math-utils.php',
        'Quizess\\Utils\\Sanitization_Utils' => __DIR__ . '/../..' . '/src/utils/class-sanitization-utils.php',
        'Quizess\\Utils\\Url_Utils' => __DIR__ . '/../..' . '/src/utils/class-url-utils.php',
        'Quizess\\Utils\\Validation' => __DIR__ . '/../..' . '/src/utils/class-validation.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit6976946bdcd0f4748451deb8ad722a9c::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit6976946bdcd0f4748451deb8ad722a9c::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit6976946bdcd0f4748451deb8ad722a9c::$classMap;
