...
return array(
    ...
    'Eightshift_Libs\\Assets\\Manifest' => $vendorDir . '/infinum/eightshift-libs/src/assets/class-manifest.php',
    'Eightshift_Libs\\Assets\\Manifest_Data' => $vendorDir . '/infinum/eightshift-libs/src/assets/interface-manifest-data.php',
    ...
    'Eightshift_Libs\\Exception\\Missing_Block' => $vendorDir . '/infinum/eightshift-libs/src/exception/class-missing-block.php',
    'Eightshift_Libs\\Exception\\Missing_Manifest' => $vendorDir . '/infinum/eightshift-libs/src/exception/class-missing-manifest.php',
    'Eightshift_Libs\\Routes\\Callable_Field' => $vendorDir . '/infinum/eightshift-libs/src/rest-routes/interface-callable-field.php',
    'Eightshift_Libs\\Routes\\Callable_Route' => $vendorDir . '/infinum/eightshift-libs/src/rest-routes/interface-callable-route.php',
    'Eightshift_Libs\\Routes\\Registrable_Field' => $vendorDir . '/infinum/eightshift-libs/src/rest-routes/interface-registrable-field.php',
    'Eightshift_Libs\\Routes\\Registrable_Route' => $vendorDir . '/infinum/eightshift-libs/src/rest-routes/interface-registrable-route.php',
    'Eightshift_Libs\\Routes\\Route' => $vendorDir . '/infinum/eightshift-libs/src/rest-routes/interface-route.php',
    ...
    'Quizess\\Admin\\Admin' => $baseDir . '/src/admin/class-admin.php',
    'Quizess\\Admin\\Media' => $baseDir . '/src/admin/class-media.php',
    'Quizess\\Admin\\Menu' => $baseDir . '/src/admin/class-menu.php',
    'Quizess\\Admin\\Menu_Page' => $baseDir . '/src/admin/class-menu-page.php',
    'Quizess\\Admin\\Questions' => $baseDir . '/src/admin/class-questions.php',
    'Quizess\\Admin\\Quiz' => $baseDir . '/src/admin/class-quiz.php',
    'Quizess\\Admin\\Users' => $baseDir . '/src/admin/class-users.php',
    'Quizess\\Assets\\Manifest' => $baseDir . '/src/assets/class-manifest.php',
    'Quizess\\Assets\\Manifest_Helper' => $baseDir . '/src/assets/class-manifest-helper.php',
    'Quizess\\Blocks\\Abstracts\\Base_Block' => $baseDir . '/src/blocks/abstracts/class-base-block.php',
    'Quizess\\Blocks\\Blocks' => $baseDir . '/src/blocks/class-blocks.php',
    'Quizess\\Blocks\\Blocks_Utils' => $baseDir . '/src/blocks/class-blocks-utils.php',
    'Quizess\\Blocks\\Interfaces\\Block' => $baseDir . '/src/blocks/interfaces/interface-block.php',
    'Quizess\\Blocks\\Section' => $baseDir . '/src/blocks/class-section.php',
    'Quizess\\Core\\Config' => $baseDir . '/src/class-config.php',
    'Quizess\\Core\\Main' => $baseDir . '/src/class-main.php',
    'Quizess\\Front\\Front' => $baseDir . '/src/front/class-front.php',
    'Quizess\\Languages\\Internationalization' => $baseDir . '/src/languages/class-internationalization.php',
    'Quizess\\Routes\\Base_Route' => $baseDir . '/src/rest/class-base-route.php',
    'Quizess\\Routes\\Field\\Post_Fields' => $baseDir . '/src/rest/fields/class-post-fields.php',
    'Quizess\\Routes\\Route\\Get_Dashboard_Options' => $baseDir . '/src/rest/routes/class-get-dashboard-options.php',
    'Quizess\\Routes\\Route\\Get_Menus' => $baseDir . '/src/rest/routes/class-get-menus.php',
    'Quizess\\Routes\\Route\\Get_Quizess' => $baseDir . '/src/rest/routes/class-get-quizess.php',
    'Quizess\\Routes\\Route\\Patch_General_Options' => $baseDir . '/src/rest/routes/class-patch-general-options.php',
    'Quizess\\Routes\\Route\\Patch_Scores' => $baseDir . '/src/rest/routes/class-patch-scores.php',
    'Quizess\\Routes\\Route\\Post_Scores' => $baseDir . '/src/rest/routes/class-post-scores.php',
    'Quizess\\Routes\\Route_Security' => $baseDir . '/src/rest/interface-route-security.php',
    'Quizess\\Routes\\Routes_Security' => $baseDir . '/src/rest/class-routes-security.php',
    'Quizess\\Utils\\Compatibility' => $baseDir . '/src/utils/class-compatibility.php',
    'Quizess\\Utils\\Error_Logger' => $baseDir . '/src/utils/class-error-logger.php',
    'Quizess\\Utils\\Math_Utils' => $baseDir . '/src/utils/class-math-utils.php',
    'Quizess\\Utils\\Sanitization_Utils' => $baseDir . '/src/utils/class-sanitization-utils.php',
    'Quizess\\Utils\\Url_Utils' => $baseDir . '/src/utils/class-url-utils.php',
    'Quizess\\Utils\\Validation' => $baseDir . '/src/utils/class-validation.php',
